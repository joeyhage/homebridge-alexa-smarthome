...
class HomebridgeAlexaSkill {
  public static readonly TEST_SKILL_ID =
    'eyJza2lsbElkIjoiYW16bjEuYXNrLnNraWxsLmEyOGM0M2UxLWNiYTYtNGFhYy05M2NhLTUwOWU4YzdjZTM5YiIsInN0YWdlIjoiZGV2ZWxvcG1lbnQifQ==';
  public static readonly PROD_SKILL_ID =
    'eyJza2lsbElkIjoiYW16bjEuYXNrLnNraWxsLjJhZjAwOGJiLTJiYjAtNGJlZi1iMTMxLWUxOTFmOTQ0YTg3ZSIsInN0YWdlIjoibGl2ZSJ9';
}
...
export class AlexaApiWrapper {
  ...
  getSmarthomeDevices(): TaskEither<AlexaApiError, void> {
    return pipe(
      TE.tryCatch(
        () =>
          AlexaApiWrapper.toPromise<GetDetailsForDevicesResponse>(
